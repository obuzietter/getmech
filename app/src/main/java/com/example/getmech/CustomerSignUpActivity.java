        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toaster.showToast(CustomerSignUpActivity.this, "Account created successfully");
                    ...
                    reference.child(userID).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toaster.showToast(CustomerSignUpActivity.this, "Successfully updated");
                                Log.e("CustomerSignUpActivity","Sent to db");

                            } else {
                                Toaster.showToast(CustomerSignUpActivity.this, "Update failed");
                                Log.e("CustomerSignUpActivity","Not sent to db");
                            }
                        }
                    });
//sending email verification
                    firebaseAuth.getCurrentUser().sendEmailVerification();
                    Toaster.showToast(CustomerSignUpActivity.this, "Check your Email to verify");
                    ...
                    Toaster.showToast(CustomerSignUpActivity.this, task.getException().getLocalizedMessage());
                }
